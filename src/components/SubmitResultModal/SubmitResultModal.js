...
export default function SubmitResultModal({ isOpen, onClose, numNodes, numEdges, isDag }) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="stat-item">
            <span className="stat-label">Is Directed Acyclic Graph (DAG)?</span>
            <span className={`stat-value badge ${isDag ? 'badge-success' : 'badge-error'}`}>
              {isDag ? 'Yes' : 'No'}
            </span>
          </div>
        </div>
